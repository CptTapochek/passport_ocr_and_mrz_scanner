...
class DBAKeys {
  ...
  factory DBAKeys.fromMRZ(MRZD mrz) {
  ...
  Uint8List get keySeed {
    if(_cachedSeed == null) {
      ...
      final cdn = MRZD.calculateCheckDigit(paddedMrtdNum);
      final cdb = MRZD.calculateCheckDigit(_dob);
      final cde = MRZD.calculateCheckDigit(_doe);
